...
export const makeHouse = ({ id, houseInput }, history) => dispatch => {
  return axios
    .post('https://labs12-real-estate.herokuapp.com/api/houses/getprecisevaluemock', {
      low: houseInput.parcelData.zestimateValuationRangeLow,
      high: houseInput.parcelData.zestimateValuationRangeHigh,
